...
QUERY;
    ...
    #[
        ...
        DataFixture(ProductFixture::class, ['name'  => 'Simple product',
                                            'sku'   => 'simple_product',
                                            'price' => 40
        ], 'p3'),
        DataFixture(ProductFixture::class, [
            'name'          => 'Simple with related product',
            'sku'           => 'simple_with_related_product ',
            'price'         => 100,
            'product_links' => ['$p3.sku$', '$p1.sku$', '$p2.sku$']
        ], 'p1'),
