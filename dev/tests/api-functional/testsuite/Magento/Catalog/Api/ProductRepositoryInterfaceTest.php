...
class ProductRepositoryInterfaceTest extends WebapiAbstract
{
    ...
    public function testImageRolesWithMultipleStores()
    {
        ...
        $defaultWebsiteId                                                       = $this->loadWebsiteByCode(
            'base'
        )->getId();
        $defaultStoreId                                                         = $this->loadStoreByCode(
            'default'
        )->getId();
        $secondStoreId                                                          = $this->loadStoreByCode(
         ...
         */
        $customAttributes                          = $this->convertCustomAttributesToAssociativeArray(
            $response['custom_attributes']
        );
        $customAttributes['image']                 = null;
        $customAttributes['small_image']           = null;
        $customAttributes['thumbnail']             = null;
        $customAttributes                          = $this->convertAssociativeArrayToCustomAttributes(
            $customAttributes
        );
        $storeProductData                          = $response;
