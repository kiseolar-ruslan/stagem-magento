...
class ProductRepositoryPriceModeWebsiteChangePriceTest extends WebapiAbstract
{
    ...
    public function testChangePriceForStore()
    {
        ...
        $store1 = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(Store::class);
        $store1->load(self::STORE1_CODE_FROM_FIXTURE);

        /** @var $store2 \Magento\Store\Model\Group */
        $store2 = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(Store::class);
