...
class MemoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $object = new \integration\framework\Magento\TestFramework\Helper\Memory($this->_shell);
        $this->_shell->expects(
            $this->once()
        )->method(
            'execute'
    ...
    {
        $this->assertEquals($expected, \integration\framework\Magento\TestFramework\Helper\Memory::convertToBytes($number));
    }
    ...
    public function testConvertToBytesBadFormat($number)
    {
        ...
        \integration\framework\Magento\TestFramework\Helper\Memory::convertToBytes($number);
    }
    ...
    public function testConvertToBytesInvalidArgument()
    {
        ...
        \integration\framework\Magento\TestFramework\Helper\Memory::convertToBytes('3Z');
    }
    ...
    public function testConvertToBytesOutOfBounds()
    {
        ...
        \integration\framework\Magento\TestFramework\Helper\Memory::convertToBytes('2P');
    }
}
