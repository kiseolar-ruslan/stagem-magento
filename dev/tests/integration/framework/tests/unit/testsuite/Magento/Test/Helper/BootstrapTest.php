...
{
    /**
     * @var \integration\framework\Magento\TestFramework\Helper\Bootstrap
     */
    protected $_object;
    ...
    protected function setUp(): void
    {
        ...
        $this->_object = new \integration\framework\Magento\TestFramework\Helper\Bootstrap($this->_bootstrap);
    }
    ...
    {
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::setInstance($this->_object);
        return $this->_object;
    }
     ...
     */
    public function testGetInstanceAllowed(
        \integration\framework\Magento\TestFramework\Helper\Bootstrap $expectedInstance)
    {
        $this->assertSame($expectedInstance, \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance());
    }
    ...
    public function testCanTestHeaders()
    {
        if (!function_exists('xdebug_get_headers')) {
            $this->assertFalse(
                \integration\framework\Magento\TestFramework\Helper\Bootstrap::canTestHeaders(),
        ...
        $this->assertEquals($expectedCanTest, \integration\framework\Magento\TestFramework\Helper\Bootstrap::canTestHeaders());
