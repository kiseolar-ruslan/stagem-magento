...
class Application
{
    ...
    public function initialize($overriddenParams = [])
    {
        ...
        integration\framework\Magento\TestFramework\Helper\Bootstrap::setObjectManager($objectManager);
        $this->initLogger();
    ...
    public function loadArea($areaCode)
    {
        ...
        $scope = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
        ...
        $app = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Framework\App\AreaList::class);
        ...
        if (in_array($areaCode, $areasForPartialLoading, true)) {
            ...
            \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->loadArea($areaCode);
        }
    }
