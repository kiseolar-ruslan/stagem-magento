...
class Eav
{
    ...
    public static function setIncrementIdPrefix($entityType, $prefix)
    {
        ...
        $entityTypeModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Eav\Model\Entity\Type::class
        )->loadByCode(
            $entityType
        );
        /** @var \Magento\Eav\Model\Entity\Store $entityStore */
        $entityStore = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
