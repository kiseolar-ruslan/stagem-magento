...
class FilterTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetDateFromToHtmlWithValue()
    {
        ...
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Framework\View\DesignInterface::class)
        ...
        $dateFormat = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
