...
class UpdateTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_resourceModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testFetchUpdatesByHandle()
    {
        ...
        $theme = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testSaveAfterClearCache()
    {
        ...
        $appCache = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\App\Cache::class
        );
        /** @var \Magento\Framework\App\Cache\Type\Layout $layoutCache */
        $layoutCache = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
