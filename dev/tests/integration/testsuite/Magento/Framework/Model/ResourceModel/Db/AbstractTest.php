...
class AbstractTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $resource = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function testGetTableName()
    {
        ...
        $tableSuffix = 'suffix';
        $resource = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Framework\App\ResourceConnection::class,
            ['tablePrefix' => 'prefix_']
        );
        $context = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
