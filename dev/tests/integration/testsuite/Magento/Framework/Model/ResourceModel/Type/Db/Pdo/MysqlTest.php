...
class MysqlTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $db = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->getBootstrap()->getApplication()->getDbInstance();
        $config = [
            'profiler' => [
        ...
        $object = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
