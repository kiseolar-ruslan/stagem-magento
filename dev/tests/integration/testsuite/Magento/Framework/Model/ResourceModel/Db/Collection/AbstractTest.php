...
class AbstractTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $resourceModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        $eventManager = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\Event\ManagerInterface::class
        );

        $entityFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\Data\Collection\EntityFactory::class
        );
        $logger = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Psr\Log\LoggerInterface::class);
