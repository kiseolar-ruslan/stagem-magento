...
class FileSystemReaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $fileResolver = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Framework\Search\Request\Config\FileResolverStub::class
        );
        $this->object = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
