...
class MergeTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $layoutUpdate1 = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $layoutUpdate2 = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Widget\Model\Layout\Update::class
        );
