...
class BlockTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->block = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Framework\View\Layout\Reader\Block::class
        );
        $this->readerContext = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
