...
class MediaStorageUploaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->uploaderFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                              ->get(\Magento\MediaStorage\Model\File\UploaderFactory::class);

        $this->filesystem = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
