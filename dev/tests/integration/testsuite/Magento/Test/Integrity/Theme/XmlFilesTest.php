...
class XmlFilesTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function viewConfigFileDataProvider()
    {
        ...
        $componentDirSearch = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function themeConfigFileExistsDataProvider()
    {
        ...
        $componentRegistrar = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
