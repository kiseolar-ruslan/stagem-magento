...
class LayoutTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->configure(
    ...
    protected function _composeXml(\Magento\Framework\View\Design\ThemeInterface $theme)
    {
        ...
        $layoutUpdate = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    {
        $result = [];
        $themeCollection = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function pageTypesDeclarationDataProvider()
    {
        ...
        $themeUpdates = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        $themeUpdatesOverride = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                             ->create(
    ...
    protected static function _getCachedFiles(
        ...
        if (!isset(self::$_cachedFiles[$cacheKey])) {
            ...
            $fileList = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
