...
class EmailTemplateConfigFilesTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testTemplateReference($templateId)
    {
        ...
        $emailConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testMergedFormat()
    {
        ...
        $reader = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
