...
class DiConfigFilesTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function _prepareFiles()
    {
        ...
        $modulesReader = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testDiConfigFileWithoutMerging($filePath, $xml)
    {
        ...
        $schemaLocator = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
