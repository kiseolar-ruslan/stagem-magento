    ...
    public function testAllTemplates()
    {
        ...
        $invoker(
            function ($module, $template, $class, $area) {
                ...
                $file = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectmanager()->get(
    ...
    public function allTemplatesDataProvider()
    {
        ...
        try {
            ...
            foreach (\Magento\Framework\App\Utility\Classes::collectModuleClasses('Block') as $blockClass => $module) {
                ...
                $context = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
                ...
                $block = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create($blockClass);
