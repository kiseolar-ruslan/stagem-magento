    ...
    public function testBlockInstantiation()
    {
        ...
        $invoker(
            function ($module, $class, $area) {
                ...
                \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->loadArea($area);

                try {
                    \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create($class);
                } catch (\Exception $e) {
