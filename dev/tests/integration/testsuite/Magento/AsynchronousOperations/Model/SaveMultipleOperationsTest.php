...
class SaveMultipleOperationsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->saveMultipleOperationsInterface = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            SaveMultipleOperationsInterface::class
        );
        $this->operationFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            OperationInterfaceFactory::class
        );
        $this->bulkStatusManagement = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            BulkStatus::class
        );
        $this->bulkSummaryFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            BulkSummaryInterfaceFactory::class
        );
        $this->entityManager = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            EntityManager::class
        );
    }
