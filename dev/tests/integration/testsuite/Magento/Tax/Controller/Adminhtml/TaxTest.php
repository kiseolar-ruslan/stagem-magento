...
class TaxTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testAjaxSaveAction($postData, $expectedData)
    {
        ...
        $result = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
        ...
        $class = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testAjaxDeleteAction($taxClassData)
    {
        ...
        $taxClassService = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Tax\Api\TaxClassRepositoryInterface::class
        );

        $taxClassFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
