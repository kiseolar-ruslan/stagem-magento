...
class RateTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testAjaxSaveAction($postData, $expectedData)
    {
        ...
        $rate = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testAjaxLoadAction($rateClassData)
    {
        ...
        $rateClassFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
        ...
        $class = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
