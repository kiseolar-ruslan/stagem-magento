...
class DesignTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testChangeDesign()
    {
        ...
        $design = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Framework\View\DesignInterface::class
        );
        $storeId = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Store\Model\StoreManagerInterface::class
        )->getDefaultStoreView()->getId();
        // fixture design_change
        $designChange = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Theme\Model\Design::class
        );
    ...
    public function testLoadChangeCache()
    {
        ...
        $cachedDesign = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\App\CacheInterface::class
        )->load(
            $cacheId
        );
        $serializer = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(SerializerInterface::class);
    ...
    public function testLoadChangeTimezone($storeCode, $storeTimezone, $storeUtcOffset)
    {
        ...
        $store = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Store\Model\StoreManagerInterface::class
        )->getStore(
            $storeCode
        );
        $defaultTimeZonePath = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
