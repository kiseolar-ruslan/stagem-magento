...
class ExceptionsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->exceptions = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $this->serializer = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(Json::class);
    }
