...
class GeneralTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        parent::setUp();
        $this->_layout = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\View\LayoutInterface::class
        );
        $this->_theme = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
