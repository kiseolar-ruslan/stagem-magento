...
class CommentsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $commentedEntity = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create($commentedEntity);
    ...
    public function testGetCommentsWrongEntityException()
    {
        ...
        $entity = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
