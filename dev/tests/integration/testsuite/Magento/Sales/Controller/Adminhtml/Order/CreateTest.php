...
class CreateTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    {
        parent::setUp();
        $this->productRepository = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testIndexAction()
    {
        ...
        $this->assertGreaterThanOrEqual(
            1,
            \integration\framework\Magento\TestFramework\Helper\Xpath::getElementsCountForXpath('//*[@id="coupons:code"]', $html)
        );
    }
