...
class StoreTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetGetWebsite()
    {
        ...
        $website = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function testSetGetGroup()
    {
        ...
        $storeGroup = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    {
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->reinitialize(
            [
    ...
    public function testGetBaseUrlForCustomEntryPoint($type, $useCustomEntryPoint, $useStoreCode, $expected)
    {
        ...
        $request = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testIsUseStoreInUrl($storeInUrl, $disableStoreInUrl, $singleStoreModeEnabled, $expectedResult)
    {
        ...
        $params['context'] = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
