...
class GroupedTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->processor = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function testReindexAll()
    {
        ...
        $productCollection = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
