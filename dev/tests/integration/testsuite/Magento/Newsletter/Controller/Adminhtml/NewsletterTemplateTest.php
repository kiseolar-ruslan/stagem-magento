...
class NewsletterTemplateTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    protected function setUp(): void
    {
        ...
        $this->model = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    protected function tearDown(): void
    {
         ...
         * Unset messages
         */
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Backend\Model\Session::class)
            ->destroy();
        $this->model = null;
    }
