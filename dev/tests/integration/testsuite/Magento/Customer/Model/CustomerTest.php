...
class CustomerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->customerModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Customer\Model\Customer::class
        );
        $this->customerFactory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
