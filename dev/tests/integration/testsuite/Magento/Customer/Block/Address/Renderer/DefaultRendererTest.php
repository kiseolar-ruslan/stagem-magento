...
class DefaultRendererTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_addressConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function renderDataProvider()
    {
        ...
        $address = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
