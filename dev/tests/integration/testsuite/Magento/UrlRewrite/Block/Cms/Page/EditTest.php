...
class EditTest extends TestCase
{
    ...
    public function testPrepareLayout($blockAttributes, $expected)
    {
        ...
        $layout = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    private function _checkButtons($block, $expected)
    {
        ...
        if (isset($expected['back_button'])) {
            if ($expected['back_button']) {
                ...
                $this->assertEquals(
                    1,
                    \integration\framework\Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
    ...
    public function prepareLayoutDataProvider()
    {
        ...
        $urlRewrite = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\UrlRewrite\Model\UrlRewrite::class
        );
        /** @var $cmsPage \Magento\Cms\Model\Page */
        $cmsPage = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Cms\Model\Page::class,
            ['data' => ['page_id' => 1, 'title' => 'Test CMS Page']]
        );
        /** @var $existingUrlRewrite \Magento\UrlRewrite\Model\UrlRewrite */
        $existingUrlRewrite = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\UrlRewrite\Model\UrlRewrite::class,
