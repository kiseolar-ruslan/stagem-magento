...
class PageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRenderPage()
    {
        ...
        $context = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            \Magento\Framework\App\Action\Context::class,
            $arguments
        );
        $page = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Cms\Model\Page::class);
        $page->load('page_design_blank', 'identifier');
        // fixture
        /** @var $pageHelper \Magento\Cms\Helper\Page */
        $pageHelper = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Cms\Helper\Page::class);
        $result = $pageHelper->prepareResultPage(
            \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
                \Magento\Framework\App\Test\Unit\Action\Stub\ActionStub::class,
                ['context' => $context]
            ),
            $page->getId()
        );
        $design = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
