...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $advanced = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                 ->create(\Magento\CatalogSearch\Model\Search\ItemCollectionProvider::class);
        $this->advancedCollection = $advanced->getCollection();
        $indexerRegistry = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
