...
class ResultTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_layout = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testSetListOrders()
    {
        ...
        $resolver = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
