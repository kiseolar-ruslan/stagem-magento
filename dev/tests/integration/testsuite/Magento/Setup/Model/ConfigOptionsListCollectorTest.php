...
class ConfigOptionsListCollectorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->objectManagerProvider
            ->expects($this->any())
            ->method('get')
            ->willReturn(\integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager());
    }
    ...
    public function testCollectOptionsLists()
    {
        ...
        $setupOptions = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                     ->create(
