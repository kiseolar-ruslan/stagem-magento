...
class DefaultStockTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->indexer = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\CatalogInventory\Model\ResourceModel\Indexer\Stock\DefaultStock::class
        );
        $this->stockConfiguration = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
