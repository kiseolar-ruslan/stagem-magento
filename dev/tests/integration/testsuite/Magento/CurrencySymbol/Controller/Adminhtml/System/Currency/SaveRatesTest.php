...
class SaveRatesTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    {
        $this->currencyRate = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            Currency::class
        );
        $this->escaper = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
            Escaper::class
        );
