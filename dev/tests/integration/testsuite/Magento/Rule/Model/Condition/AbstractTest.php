...
class AbstractTest extends \PHPUnit\Framework\TestCase
{
    public function testGetValueElement()
    {
        ...
        $editableBlock = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $rule->expects($this->any())
            ->method('getForm')
            ->willReturn(
                \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(\Magento\Framework\Data\Form::class)
            );
        $model->setRule($rule);
