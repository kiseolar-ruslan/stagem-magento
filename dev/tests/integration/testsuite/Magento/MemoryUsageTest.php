...
class MemoryUsageTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \integration\framework\Magento\TestFramework\Helper\Memory
     */
    protected $_helper;
    ...
    protected function setUp(): void
    {
        ...
        $this->_helper = new \integration\framework\Magento\TestFramework\Helper\Memory(
    ...
    protected function _getAllowedMemoryUsage()
    {
        ...
        return \integration\framework\Magento\TestFramework\Helper\Memory::convertToBytes('2M');
    }
}
