...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $directoryList = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $this->_objectManager = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager();
