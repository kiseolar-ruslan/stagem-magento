...
class ProductCategoriesTest extends ProductTestBase
{
    ...
    public function testProductPositionInCategory()
    {
        ...
        $resourceConnection = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function testProductDuplicateCategories()
    {
        ...
        $errorProcessor = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
