...
class ProductOtherTest extends ProductTestBase
{
    ...
    public function testSaveProductsVisibility()
    {
        ...
        $filesystem = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        foreach ($productsBeforeImport as $productBeforeImport) {
            ...
            $productAfterImport = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
                \Magento\Catalog\Model\Product::class
            );
    ...
    public function testProductWithLinks()
    {
        ...
        $filesystem = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testProductWithUseConfigSettings()
    {
        ...
        foreach ($products as $sku => $manageStockUseConfig) {
            ...
            $stockRegistry = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
                StockRegistry::class
            );
    ...
    public function testImportDataChangeAttributeSet()
    {
        ...
        $products[] = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        $catalogConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                      ->create(\Magento\Catalog\Model\Config::class);

        /** @var \Magento\Eav\Model\Config $eavConfig */
        $eavConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testImportWithDifferentSkuCase()
    {
        ...
        $searchCriteria = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
