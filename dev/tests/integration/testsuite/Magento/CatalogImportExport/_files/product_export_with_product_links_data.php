...
$productCrosssellLink = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
...
$productUpsellLink = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                  ->create(\Magento\Catalog\Api\Data\ProductLinkInterface::class);
...
$productRelatedLink = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                   ->create(\Magento\Catalog\Api\Data\ProductLinkInterface::class);
