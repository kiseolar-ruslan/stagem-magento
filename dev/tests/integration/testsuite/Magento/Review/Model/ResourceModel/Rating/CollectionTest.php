...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->collection = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    {
        $ratingData = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
