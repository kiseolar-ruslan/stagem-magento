...
class NewTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
         ...
         */
        $groupManagement = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                        ->get(\Magento\Customer\Api\GroupManagementInterface::class);
        $notLoggedInId = $groupManagement->getNotLoggedInGroup()->getId();

        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->loadArea(\Magento\Framework\App\Area::AREA_FRONTEND);
    ...
    public function testGetCacheKeyInfo()
    {
        ...
        $themeModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
