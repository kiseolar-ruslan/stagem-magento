...
class OptionTest extends \PHPUnit\Framework\TestCase
{
    public function testGetOptionValuesCaching()
    {
        ...
        $productWithOptions = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $option = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
