...
class ProcessorTest extends TestCase
{
    ...
    public function testDeleteAttribute(): void
    {
        ...
        $model = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                              ->get(\Magento\Catalog\Model\ResourceModel\Eav\Attribute::class);
        /** @var Repository $productAttributeRepository */
        $productAttributeRepository = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testAddNewStoreGroup(): void
    {
        ...
        $storeGroup = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
