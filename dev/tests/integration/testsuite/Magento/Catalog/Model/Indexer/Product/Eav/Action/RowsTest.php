...
class RowsTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_productAction = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
    ...
    public function testUpdateAttributes()
    {
        ...
        $attr = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Eav\Model\Config::class)
