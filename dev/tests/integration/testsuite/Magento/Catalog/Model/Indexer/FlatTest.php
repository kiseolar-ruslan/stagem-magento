...
class FlatTest extends \Magento\TestFramework\Indexer\TestCase
{
    ...
    protected static function loadAttributeCodes()
    {
        ...
        $catalogConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    {
        $app = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getInstance()->getBootstrap()->getApplication();
