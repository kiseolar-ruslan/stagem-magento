...
class PriceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function tearDownAfterClass(): void
    {
        ...
        /** @var ReinitableConfigInterface $reinitiableConfig */
        $reinitiableConfig = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
        ...
        $observer = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Framework\Event\Observer::class
        );
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(SwitchPriceAttributeScopeOnConfigChange::class)
            ->execute($observer);
    }
