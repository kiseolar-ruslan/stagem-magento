...
class ListCompareTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->_session = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                       ->get(\Magento\Customer\Model\Session::class);
        $this->_visitor = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testAddProductWithSession()
    {
        ...
        $product2 = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
                                                                                 ->create(\Magento\Catalog\Model\Product::class)
                                                                                 ->load(6);
