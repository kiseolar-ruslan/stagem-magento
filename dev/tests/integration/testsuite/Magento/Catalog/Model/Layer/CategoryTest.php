...
class CategoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testApply()
    {
        $this->_model->getState()->addFilter(
            \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
                ...
                [
                    'data' => [
                        'filter' => \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    {
        $existingCategory = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testGetState()
    {
        ...
        $state = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
