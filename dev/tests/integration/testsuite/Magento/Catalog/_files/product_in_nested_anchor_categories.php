...
foreach ($categories as $category) {
    $categoryModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
...
foreach ($products as $product) {
    ...
    $productModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
