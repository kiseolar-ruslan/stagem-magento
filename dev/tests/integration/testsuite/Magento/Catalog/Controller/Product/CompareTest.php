...
class CompareTest extends AbstractController
{
    ...
    protected function _prepareCompareListWithProductNameXss(): void
    {
        ...
        $visitor = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        $item = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    {
        $customer = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        $session = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        /** @var $item \Magento\Catalog\Model\Product\Compare\Item */
        $item = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
        ...
        \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Customer\Model\Visitor::class)
            ->load($visitor->getId());
    ...
    protected function _assertCompareListEquals(array $expectedProductIds): void
    {
        ...
        $compareItems = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
