...
class InlineTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_translateInline = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
    ...
    public function testAjaxUrl()
    {
        ...
        $url = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(\Magento\Framework\UrlInterface::class);
