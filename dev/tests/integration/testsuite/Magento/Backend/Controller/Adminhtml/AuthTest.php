...
class AuthTest extends \Magento\TestFramework\TestCase\AbstractController
{
    ...
    public function testNotLoggedLoginAction()
    {
        ...
        $backendUrlModel = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Backend\Model\UrlInterface::class
        );
    ...
    public function testNotLoggedLoginActionWithRedirect()
    {
        ...
        $response = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
    ...
    public function testDeniedJsonAction()
    {
        ...
        $data = [
            'ajaxExpired' => 1,
            'ajaxRedirect' => \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
                \Magento\Backend\Helper\Data::class
            )->getHomePageUrl(),
        ];
    ...
    public function testDeniedIframeAction()
    {
        ...
        $homeUrl = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->get(
            \Magento\Backend\Helper\Data::class
        )->getHomePageUrl();
