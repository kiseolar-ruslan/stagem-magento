...
class AbstractActionTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testAclInNodes($blockName, $resource, $isLimitedAccess)
    {
        ...
        $noticeInbox = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()->create(
        ...
        $acl = \integration\framework\Magento\TestFramework\Helper\Bootstrap::getObjectManager()
